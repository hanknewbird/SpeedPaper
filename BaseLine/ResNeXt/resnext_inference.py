...
if __name__ == "__main__":
    ...
    # config
    path_state_dict = os.path.join(BASE_DIR, "..", "file", "resnext50_32x4d-7cdf4587.pth")
    path_img = os.path.join(BASE_DIR, "..", "file","Golden Retriever from baidu.jpg")
    # path_img = os.path.join(BASE_DIR, "..", "file", "tiger cat.jpg")
    path_classnames = os.path.join(BASE_DIR, "..", "file", "imagenet1000.json")
    path_classnames_cn = os.path.join(BASE_DIR, "..", "file", "imagenet_classnames.txt")
